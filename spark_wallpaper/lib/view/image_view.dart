...
class _ImageViewState extends State<ImageView> {
  var filePath;
  static const platform = const MethodChannel('com.devashish.spark_wallpaper/wallpaper');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: <Widget>[
          Hero(
            tag: widget.imgPath.replaceAll('h=600&w=400','h=1800&w=1200'),
            child: Container(
              height: MediaQuery.of(context).size.height,
              width: MediaQuery.of(context).size.width,
              child: kIsWeb
                  ? Image.network(widget.imgPath.replaceAll('h=600&w=400','h=1800&w=1200'), fit: BoxFit.cover)
                  : CachedNetworkImage(
                      imageUrl: widget.imgPath.replaceAll('h=600&w=400','h=1800&w=1200'),
            ...
            child: Column(
              ...
              children: <Widget>[
                InkWell(
                    onTap: () {
                      if (kIsWeb) {
                        _launchURL(widget.imgPath.replaceAll('h=600&w=400','h=1800&w=1200'));
  ...
  Future<void> _setWallpaper(int wallpaperType) async {
    var file =
    await DefaultCacheManager().getSingleFile(widget.imgPath.replaceAll('h=600&w=400','h=1800&w=1200'));
    try {
